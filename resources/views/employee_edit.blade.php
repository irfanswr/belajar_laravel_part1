                ...
                <div class="card-body">
                    ...
                    <form method="post" action="/employee/update/{{ $employee->id }}">
                        ...
                        <div class="form-group">
                            <label>Nama</label>
                            <input type="text" name="nama" class="form-control" placeholder="Nama pegawai .." value=" {{ $employee->nama }}">
                        ...
                        <div class="form-group">
                            <label>Alamat</label>
                            <textarea name="alamat" class="form-control" placeholder="Alamat pegawai .."> {{ $employee->alamat }} </textarea>
